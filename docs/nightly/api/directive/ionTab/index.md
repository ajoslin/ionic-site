...
<div class="improve-docs">
  <a href='http://github.com/driftyco/ionic/edit/master/js/ext/angular/src/directive/ionicTabBar.js#L212'>
    Improve this doc
  </a>
</div>
...
<table class="table" style="margin:0;">
  ...
  <code>expression</code>
      ...
      <td>
        <p>By default, the tab will be selected on click. If ngClick is set, it will not.  You can explicitly switch tabs using <a href="/docs/nightly/api/controller/ionicTabs#select">ionicTabBar controller&#39;s select method</a>.</p>
