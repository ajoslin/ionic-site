...
<a href="/docs/nightly/api/directive/ionNavBar"><code>ionNavBar</code></a>.</p>
  ...
  <code>boolean</code>
      ...
      <td>
        <p>Whether to hide the parent <a href="/docs/nightly/api/directive/ionNavBar"><code>ionNavBar</code></a>.</p>
